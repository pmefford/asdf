...
public class AccountResource {
    ...
    public ResponseEntity<?> registerAccount(@Valid @RequestBody UserDTO userDTO, HttpServletRequest request) {
        ...
        queryLogin.setKey(userDTO.getLogin());
        queryLogin.setInclusiveEnd(true);
        Query queryEmail = new Query();
        queryEmail.setKey(userDTO.getEmail());
        queryEmail.setInclusiveEnd(true);
        return userRepository.findOneByLogin(queryLogin).stream().findFirst()
            .map(user -> new ResponseEntity<>("login already in use", HttpStatus.BAD_REQUEST))
            .orElseGet(() -> userRepository.findOneByEmail(queryEmail).stream().findFirst()
    ...
    public ResponseEntity<String> saveAccount(@RequestBody UserDTO userDTO) {
        ...
        query.setKey(userDTO.getLogin());
        query.setInclusiveEnd(true);
        return userRepository
            .findOneByLogin(query).stream().findFirst()
