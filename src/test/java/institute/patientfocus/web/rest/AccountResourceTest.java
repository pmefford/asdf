...
import institute.patientfocus.web.rest.dto.UserDTO;
...
public class AccountResourceTest {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        user.setAuthorities(authorities.stream().map(Authority::getName).collect(Collectors.toList()));
    ...
    public void testRegisterValid() throws Exception {
        ...
        query.setKey("joe");
        Optional<User> user = userRepository.findOneByLogin(query)
            .stream()
            .findFirst();
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        Query query = new Query();
        query.setKey("funky@example.com");
        query.setInclusiveEnd(true);
        Optional<User> user = userRepository.findOneByEmail(query).stream().findFirst();
    ...
    public void testRegisterInvalidEmail() throws Exception {
        ...
        query.setKey("bob");
        query.setInclusiveEnd(true);
        Optional<User> user = userRepository.findOneByLogin(query).stream().findFirst();
        assertThat(user.isPresent()).isFalse();
    }
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        Query query = new Query();
        query.setKey("alicejr@example.com");
        query.setInclusiveEnd(true);
        Optional<User> userDup = userRepository.findOneByEmail(query).stream().findFirst();
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        query.setKey("johnjr");
        query.setInclusiveEnd(true);
        Optional<User> userDup = userRepository.findOneByLogin(query).stream().findFirst();
        assertThat(userDup.isPresent()).isFalse();
    }
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findOne(AuthoritiesConstants.USER).getName());
    }
}
